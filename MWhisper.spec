...
a = Analysis(
    ...
    datas=datas + [
        ...
        ('assets/menu_icon_recording_0.png', 'assets'),
        ('assets/menu_icon_recording_1.png', 'assets'),
        ('assets/menu_icon_recording_2.png', 'assets'),
        ('assets/menu_icon_recording_3.png', 'assets'),
        ('config.json', '.'),
        ('src', 'src'),
    ],
